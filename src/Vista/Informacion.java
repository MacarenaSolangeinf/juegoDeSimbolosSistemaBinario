...
//		this.setBounds(104, 104, 988, 658);
		...
		//
		 ...
		 JLabel lblNewLabelC = new JLabel("Luego de haber jugado, completá el siguiente formulario:");
		    lblNewLabelC.setForeground(new Color(0, 0, 0));
			lblNewLabelC.setFont(new Font("Monotype Corsiva", Font.BOLD, 27));
			lblNewLabelC.setBounds(35, 380, 605, 120);
			this.add(lblNewLabelC);
			this.setBounds(104, 104, 988, 658);
			JLabel labelURL6 = new JLabel();
			labelURL6.setName("https://docs.google.com/forms/d/e/1FAIpQLScwUgPl9VYsAt2tFevYOu-uXGU_l3zR29DEkyIZEi8cnfLJsw/viewform");
			labelURL6.setText("<html> <a href=\"\">https://docs.google.com/forms/d/e/1FAIpQLScwUgPl9VYsAt2tFevYOu-uXGU_l3zR29DEkyIZEi8cnfLJsw/viewform");
			labelURL6.setFocusable(false);
			labelURL6.setVisible(true);
			labelURL6.setEnabled(true);
			 labelURL6.setForeground(new Color(0, 0, 0));
			 labelURL6.setFont(new Font("Monotype Corsiva", Font.BOLD, 20));
			 labelURL6.setCursor(new Cursor(Cursor.HAND_CURSOR));
			 Url url6 = new Url(labelURL6);
			 url6.goWebsite();
		      this.add(labelURL6);
			labelURL6.setBounds(30, 400, 605, 160);
			this.setBounds(104, 104, 988, 658);
			
		    JLabel lblNewLabelMG = new JLabel("¡¡Muchas gracias!!");
		    lblNewLabelMG.setForeground(new Color(0, 0, 0));
			lblNewLabelMG.setFont(new Font("Monotype Corsiva", Font.BOLD, 27));
			lblNewLabelMG.setBounds(300, 460, 605, 120);
			this.add(lblNewLabelMG);
			this.setBounds(104, 104, 988, 658);
